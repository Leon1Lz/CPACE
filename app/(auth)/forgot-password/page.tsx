              ...
              <Alert className="border-emerald-200 bg-emerald-50 text-emerald-800 rounded-xl">
                <AlertDescription>
                  ...
                  {message.includes("Google") && (
                    <div className="mt-3 p-3 bg-white border border-emerald-200 rounded-lg flex items-center gap-3">
                      ...
                      <div className="text-sm">
                        <p className="font-medium text-gray-700">Your account is linked to Google</p>
                        <Link href="/login" className="text-emerald-600 hover:text-emerald-700 font-semibold text-xs">
